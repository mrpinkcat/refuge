...
function printCard(info) {
    ...
    if (info.adopt == true) {
        if (info.sex == 'male') {
            card = '<div id="card-div-' + info.uid + '" class="col s3"><div id="' + info.uid + '" class="card hoverable scale-transition"><div class="card-image"><img id ="cardImage" src="' + info.imageURL + '"><span class="card-title red-text text-accent-3"><b>ADOPTÉ</b></span><a href="#' + info.uid + '-modal" class="btn-floating halfway-fab waves-effect waves-light blue" onclick="clickOnModal(\'' + info.category + '\', \'' + info.uid + '\', \'' + info.name + '\', \'' + myID + '\')"><i class="material-icons">info_outline</i></a></div><div class="card-content"><p class="center-align"><b>' + info.name + info.formatSex + '<br>' + info.birthDate + '</b></p></div><div></div>';
            modal = '<div id="' + info.uid + '-modal" class="modal"><div id="card-' + info.number + '" class="col s12 m7"><div class="card horizontal"><div class="card-image"><img src="' + info.imageURL + '"></div><div class="card-stacked"><div class="card-content"><h4>' + info.name + '</h4><p><b>Né en ' + info.birthDate + ' - Mâle' + info.formatSex + ' - ' + info.breed + '</b></p><br><p>' + info.description + '</p><br><p id="' + info.uid + '-modal-view">Vue...</p><br><p><b>N°' + info.number + '</b></p><h4 class="red-text accent-4"><b>ADOPTÉ</b></h4></div></div></div></div></div>';
        }
        if (info.sex == 'female') {
            ...
            modal = '<div id="' + info.uid + '-modal" class="modal"><div id="card-' + info.number + '" class="col s12 m7"><div class="card horizontal"><div class="card-image"><img src="' + info.imageURL + '"></div><div class="card-stacked"><div class="card-content"><h4>' + info.name + '</h4><p><b>Né en ' + info.birthDate + ' - Femelle' + info.formatSex + ' - ' + info.breed + '</b></p><br><p>' + info.description + '</p><br><p id="' + info.uid + '-modal-view">Vue...</p><br><p><b>N°' + info.number + '</b></p><h4 class="red-text accent-4"><b>ADOPTÉE</b></h4></div></div></div></div></div>';
        }
    }
    if (info.adopt == false) {
        if (info.sex == 'male') {
            card = '<div id="card-div-' + info.uid + '" class="col s3"><div id="' + info.uid + '" class="card hoverable scale-transition"><div class="card-image"><img id ="cardImage" src="' + info.imageURL + '"><a href="#' + info.uid + '-modal" class="btn-floating halfway-fab waves-effect waves-light blue" onclick="clickOnModal(\'' + info.category + '\', \'' + info.uid + '\', \'' + info.name + '\', \'' + myID + '\')"><i class="material-icons">info_outline</i></a></div><div class="card-content"><p class="center-align"><b>' + info.name + ' ' + info.formatSex + '<br>' + info.birthDate + '</b></p></div><div></div>';
            modal = '<div id="' + info.uid + '-modal" class="modal"><div id="card-' + info.number + '" class="col s12 m7"><div class="card horizontal"><div class="card-image"><img src="' + info.imageURL + '"></div><div class="card-stacked"><div class="card-content"><h4>' + info.name + '</h4><p><b>Né en ' + info.birthDate + ' - ' + info.formatSex + ' - ' + info.breed + '</b></p><br><p>' + info.description + '</p><br><p id="' + info.uid + '-modal-view">Vue...</p><br><p><b>N°' + info.number + '</b></p></div></div></div></div></div>';
        }
        if (info.sex == 'female') {
            card = '<div id="card-div-' + info.uid + '" class="col s3"><div id="' + info.uid + '" class="card hoverable scale-transition"><div class="card-image"><img id ="cardImage" src="' + info.imageURL + '"><a href="#' + info.uid + '-modal" class="btn-floating halfway-fab waves-effect waves-light blue" onclick="clickOnModal(\'' + info.category + '\', \'' + info.uid + '\', \'' + info.name + '\', \'' + myID + '\')"><i class="material-icons">info_outline</i></a></div><div class="card-content"><p class="center-align"><b>' + info.name + ' ' + info.formatSex + '<br>' + info.birthDate + '</b></p></div><div></div>';
            modal = '<div id="' + info.uid + '-modal" class="modal"><div id="card-' + info.number + '" class="col s12 m7"><div class="card horizontal"><div class="card-image"><img src="' + info.imageURL + '"></div><div class="card-stacked"><div class="card-content"><h4>' + info.name + '</h4><p><b>Né en ' + info.birthDate + ' - ' + info.formatSex + ' - ' + info.breed + '</b></p><br><p>' + info.description + '</p><br><p id="' + info.uid + '-modal-view">Vue...</p><br><p><b>N°' + info.number + '</b></p></div></div></div></div></div>';
...
function clickOnModal(category, uid, name, userID) {
    socket.emit('clickOnModal', category, uid, name, userID);
